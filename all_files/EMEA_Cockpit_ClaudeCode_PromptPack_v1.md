...
3. Check site coverage in the output — confirm all 24 active EMEA sites are present (Blonie 10381 removed — site closed 08 Mar 2026)
...
STEP 6 — Write physics summary to Enterprise_Panel
After writing Physics Block 1, also update the EUC physics summary row on Enterprise_Panel:
- Find the row labelled "↳ Physics: EUC Burn" on Enterprise_Panel
- Write Units Remaining, Required Weekly Burn, and Physics Status to that row
- If the row does not exist, log a warning — do not create it (use Build Pack Prompt 12 in the Claude Excel Add-In to create it)

STEP 7 — Add to dry-run output
...
*Run Build Pack Prompt 12 (Claude Excel Add-In) before Prompt 11 to create physics summary rows on Enterprise_Panel.*
